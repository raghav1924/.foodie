...
public class MessageConfiguration {
    ...
    private String orderStatus_queue_name="orderStatus_queue_userService";
    ...
    public Binding orderStatusBinding(Queue orderStatusQueue, DirectExchange d)
    {
        ...
        return BindingBuilder.bind(orderStatusQueue).to(d).with("orderStatus_routing_userService");
    }
}
